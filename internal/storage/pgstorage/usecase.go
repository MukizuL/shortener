...
func (s *PostgresService) BatchCreateShortURL(ctx context.Context, urlBase string, data []dto.BatchRequest) ([]dto.BatchResponse, error) {
...
func (s *PostgresService) CreateShortURL(ctx context.Context, urlBase, fullURL string) (string, error) {
	ID := helpers.RandomString(6)
...
func (s *PostgresService) GetLongURL(ctx context.Context, ID string) (string, error) {
	var result string
...
func (s *PostgresService) OffloadStorage(ctx context.Context, filepath string) error {
	return nil
}
